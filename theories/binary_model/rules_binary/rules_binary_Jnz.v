...
Section cap_lang_spec_rules.
  ...
  Lemma step_Jnz Ep K pc_p pc_g pc_b pc_e pc_a w dst src regs :
  ...
  Lemma step_jnz_success_next E K r1 r2 pc_p pc_g pc_b pc_e pc_a pc_a' w w1 :
  ...
  Lemma step_jnz_success_jmp E K r1 r2 pc_p pc_g pc_b pc_e pc_a w w1 w2 :
    decodeInstrW w = Jnz r1 r2 →
    isCorrectPC (inr (pc_p,pc_g,pc_b,pc_e,pc_a)) →
    w2 ≠ inl 0%Z →
    nclose specN ⊆ E →
