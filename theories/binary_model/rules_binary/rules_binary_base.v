...
Section cap_lang_spec_rules.
  ...
  Lemma step_halt E K pc_p pc_g pc_b pc_e pc_a w :
    decodeInstrW w = Halt →
  ...
  Proof.
    ...
    iMod ("Hclose" with "[Hown]") as "_".
    { iNext. iExists _,_;iFrame. iPureIntro. eapply rtc_r;eauto. simpl.
      prim_step_from_exec. }
    by iFrame.
  Qed.

  Lemma step_fail E K pc_p pc_g pc_b pc_e pc_a w :
    decodeInstrW w = Fail →
    isCorrectPC (inr (pc_p,pc_g,pc_b,pc_e,pc_a)) →
    nclose specN ⊆ E →
